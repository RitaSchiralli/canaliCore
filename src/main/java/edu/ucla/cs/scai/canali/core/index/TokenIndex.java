...
//		addElement(writer, new QuestionStartToken("Who is", IndexedToken.SINGULAR, QuestionStartToken.PLAIN, true));
	...
	public ArrayList<TopKOperatorToken> getTopKOperatorElements(String search) {
		...
		search = search.trim().toLowerCase();
		if (search.equals("o") || search.equals("on") || search.equals("one") || search.equals("one ") || search.equals("one o") || search.equals("one of") || search.equals("one of ") || search.equals("one of t") || search.equals("one of th") || search.equals("one of the")) {
	...
	public ArrayList<IndexedToken> getTokenElements(String search, String domainsOfProperty[], String rangesOfProperty[], String[] propertyDomains, int maxResults, String... tokenClasses) {
		...
		System.out.println("TOKENINDEX SEARCH = " + search);
